            ...
            <div className="max-w-md w-full">
                <div className="text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="h-0.5 w-16 bg-slate-200 mx-auto dark:bg-slate-700"></div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-slate-600 leading-relaxed dark:text-slate-300">
                            The page <span className="font-medium text-slate-700 dark:text-slate-200">"{pageName}"</span> could not be found in this application.
                        </p>
                    </div>
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 hover:border-slate-300 transition-colors duration-200 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 dark:text-slate-200 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 dark:hover:border-slate-600"
                        >
